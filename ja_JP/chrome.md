...
## プックマークをフォルダで整理する
  ...
  1. Chromeの右上にある![]()マークをタップします。
  2. オプションメニューの[ブックマーク]をタップします。
  3. 登録してある、それぞれのブックマークの右側にあるオプションメニューをタップします。
  4. 表示したオプションメニューで[編集]を選択します。
  5. [フォルダ]欄をタップします（このれいでは[モバイルのブックマーク]となっています）
  6. [新しいフォルダ...]をタップします。
  7. フォルダの名前を分けたいカテゴリなどにし、チェックマークをタップします（この例では[買い物]とします）
  8. 最後に[ブックマークを編集]画面から、戻る矢印ボタンをタップします。
